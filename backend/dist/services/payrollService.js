...
const calculateSalary = (input) => {
    const { monthlySalary, basicPercentage, hraPercentage, allowancePercentage, bonusPercentage, pfPercentage, professionalTax, } = input;
...
exports.default = exports.calculateSalary;
